...
exports.getAll = async (req, res) => {
  try {
    const { rating, verifiedPurchase, productId, userId, sortBy = 'newest', page = 1, limit = 50 } = req.query;
    ...
    const { count, rows: reviews } = await Review.findAndCountAll({
      ...
      order,
      include: [
        { model: db.products, as: 'product', attributes: ['id', 'name'] },
        { model: db.users, as: 'user', attributes: ['id', 'full_name', 'email', 'phone'] }
      ],
